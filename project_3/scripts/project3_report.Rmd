...
The above regression found that client gender, race, and age had a statistically significant association with the probability that a client had a disability when entering UMD. Specifically, males had $1-e^{-0.468374} = 37.4%$ lower odds of having a disability than females, white individuals had $e^{0.650568} = 91.2$ greater odds of having a disability than african american/black individuals, and a 1 year increase in age was associated with $e^{0.029878} = 3%$ greater odds of having a disability. The regression also found that being a trans-female was also statistically significant, but due to the low amount of trans-females in the sample compared to males and females, this find may not be accurate and was thus ignored. Thus, UMD may want to look into providing more in depth disability services for individuals that are more likely to have a disability, i.e. whites, females, and older clients.
